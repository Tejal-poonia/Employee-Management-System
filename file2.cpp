...
void Employee_management::insert() 
{
    ...
    file << " " << name << setw(20) << id << setw(10) << designation << setw(10) << age << setw(10) << ctc << setw(10) << experience << "\n";
    file.close();
}
    ...
    else
    {
        ...
        while (!file.eof())
        {
            if (strcmp(checkId, id) == 0)
            {
                ...
                cout << "Employee's existing data : \n" << name << "\t  " << id << "\t\t  " << designation << "\t\t   " << age << "\t\t  " << ctc << "\t\t" << experience;
                cout << "\n Enter modified Name of the Employee: ";
                cin >> name;
                cout << "\n Enter modified Employee ID ";
                cin >> id;
                cout << "\n Enter modified Designation: ";
                cin >> designation;
                cout << "\n Enter modified Employee Age: ";
                cin >> age;
                cout << "\n Enter modified Employee CTC: ";
                cin >> ctc;
                cout << "\n Enter modified Employee Experience: ";
                cin >> experience;
